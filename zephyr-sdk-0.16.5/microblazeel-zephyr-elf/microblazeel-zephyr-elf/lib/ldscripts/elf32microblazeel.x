...
OUTPUT_FORMAT("elf32-microblazeel", "elf32-microblaze",
	      "elf32-microblazeel")
/*SEARCH_DIR("=/__w/_temp/workspace/output/HOST-x86_64-w64-mingw32/microblazeel-zephyr-elf/microblazeel-zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");*/
SEARCH_DIR("=/__w/_temp/workspace/output/HOST-x86_64-w64-mingw32/microblazeel-zephyr-elf/microblazeel-zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
ENTRY (_start)
