...
OUTPUT_ARCH(nios2)
ENTRY(_start)
SEARCH_DIR("=/__w/_temp/workspace/output/HOST-x86_64-w64-mingw32/nios2-zephyr-elf/nios2-zephyr-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
